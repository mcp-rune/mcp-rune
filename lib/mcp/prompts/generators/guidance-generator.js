 ...
 *
 * @param {{ promptClass: { strategy: string, fieldGroups: Object }, modelName: string }} context
 * @returns {string} Markdown guidance section, or empty string for non-stateful prompts
 */
