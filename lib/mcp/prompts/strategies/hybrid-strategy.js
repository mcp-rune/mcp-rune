...
export class HybridStrategy extends BaseStrategy {
   ...
   * @param {Function} promptClass - The prompt class (not instance)
   * @param {Object} fields - Field values to validate
   * @param {Object} _context - Additional context (parent info, etc.)
   * @returns {Object} Validation result
   */
  static validateFields(promptClass, fields, _context = {}) {
    const errors = []
    const warnings = []
    const computed = {}
   ...
   * @returns {string}
   */
  static generateHumanSummary(promptClass, fields) {
    const fieldDefs = promptClass.fieldDefinitions || {}
   ...
   * @param {Function} _promptClass - The prompt class
   * @param {Object} fields - Field values
   * @param {Object} context - Additional context
   * @returns {Object}
   */
  static generateTechnicalSummary(_promptClass, fields, context = {}) {
    const attributes = {}
    ...
    return {
      ...
      parent_resource: context.parent_resource || undefined,
      attributes
    }
  }
