...
vi.mock('../../../../../src/runtime/vendor/langfuse/mcp-integration.js', () => ({
  traceToolCall: vi.fn(),
  traceApiCall: vi.fn(),
...
const langfuse = await import('../../../../../src/runtime/vendor/langfuse/index.js')
import { setConfigured } from '../../../../../src/runtime/vendor/langfuse/mcp-integration.js'
