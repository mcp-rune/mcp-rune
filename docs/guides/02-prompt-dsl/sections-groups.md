...
This guide is the reference for how the two work together. For the strategy that consumes them (stateless / hybrid / stateful), see the [Prompt Creation guide](./prompt-creation.md).
...
- [Prompt Creation guide](./prompt-creation.md) — the strategies (stateless / hybrid / stateful) that consume these sections.
- [Stateful Strategies guide](./stateful.md) — per-section validation and progress tracking on top of this structure.
- [Prompt Derivation Framework guide](./prompt-derivation.md) — Layer 2 of the derivation pipeline where this content is consumed.
