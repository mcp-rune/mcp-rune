...
| **Kinds (`KindDescriptor` + `KindRenderHint`)** | Attribute taxonomy: parse/serialize/toInput/fromInput/describe/validate. Drives forms, prompts, summaries, and display. Extend via `AppRegistry({ kinds })`. | [Attribute Kinds](../02-the-model/attributes-and-kinds.md) |
...
> **Projection-layer rule.** Tools, apps, prompts, and domain workflows consume only the `DataLayer` interface — never `SearchService`, `ApiClient`, or `ModelService` directly. See [The Projection-Layer Rule](../06-the-three-layers-up-close/data-layer.md#the-projection-layer-rule).
...
| What you want | Pick |
| --- | --- |
| "Add an ISBN attribute kind" | [Attribute Kinds](../02-the-model/attributes-and-kinds.md) — declare `'string:isbn'` in `AppRegistry({ kinds })`. |
| "Render `boolean` as a toggle instead of a checkbox" | [Attribute Kinds](../02-the-model/attributes-and-kinds.md) — DOM-only `registerKindRenderer` override. |
...
- **Extensions** (this section): the 7 dedicated guides above.
- **Tools** (section IV): [The three layers](../04-tools/the-three-layers.md), [Polymorphic tools](../04-tools/polymorphic-tools.md), [Tool creation](../04-tools/tool-creation.md), [Workflow creation](../04-tools/workflow-creation.md).
- **The Three Layers Up Close** (section VI): [Data layer](../06-the-three-layers-up-close/data-layer.md), [Model service](../06-the-three-layers-up-close/model-service.md), [Model layer](../06-the-three-layers-up-close/model-layer.md), [Analysis layer](../06-the-three-layers-up-close/analysis-layer.md), and the wire seams ([API client](../06-the-three-layers-up-close/api-client.md), [API convention](../06-the-three-layers-up-close/api-convention.md), [Search request shaper](../06-the-three-layers-up-close/search-request-shaper.md), [Search filters](../06-the-three-layers-up-close/search-filters.md)).
- **Apps** (section V): [MCP apps](../05-apps/mcp-apps.md), [Apps architecture](../05-apps/mcp-apps-arch.md), [Model form customization](../05-apps/model-form.md).
- **The Prompt** (section III): [Prompt creation](../03-the-prompt/prompt-creation.md), [Stateful strategies](../03-the-prompt/stateful.md), [Prompt derivation](../03-the-prompt/prompt-derivation.md), [Sections & field groups](../03-the-prompt/sections-groups.md).
- **Auth & Transport** (section VII): [OAuth 2.0 Discovery](../07-auth-and-transport/oauth2-discovery.md), [Transport & observability](../07-auth-and-transport/transport.md).
