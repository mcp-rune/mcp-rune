...
After the graph ingest in the [analysis quickstart](../analysis-quickstart-guide.md):
...
- [`graph stratifier` `kind:"edge"`](../analysis-quickstart-guide.md) on `analysis_query mode:"sample"` — sample records balanced by edge presence or degree.
