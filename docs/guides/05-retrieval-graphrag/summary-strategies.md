...
For the broader analysis-tool family, see [Analysis Memories Guide](./analysis-memories.md). For how to register your strategy through an `ApiExtension`, see [API Extensions](../09-extensions/api-extensions.md).
...
- [API Extensions](../09-extensions/api-extensions.md) — the `ApiExtensionContext` collectors, including `registerSummaryStrategy`.
- [Authoring Extensions Guide](../09-extensions/authoring-extensions.md) — step-by-step walkthrough for shipping an extension.
