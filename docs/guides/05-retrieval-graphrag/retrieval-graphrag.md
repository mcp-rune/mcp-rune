...
| **Domain**  | concepts + business rules that ground findings in your vocabulary                                     | a `DomainRegistry` passed at boot | [Domain Knowledge](../07-domain-intelligence/domain-knowledge.md) |
...
- **[Domain Knowledge](../07-domain-intelligence/domain-knowledge.md)** — the concepts and rules that ground GraphRAG-aware strategies.
