...
> Archive of the pre-redesign `README.md` sections that didn't fit the new
> npm-page-shaped landing. Kept here for the curious browsing the repo on
> GitHub. **Not linked from `index.md` or the website nav** — content
> intentionally lives in the repo only.
