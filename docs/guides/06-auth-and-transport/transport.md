...
See [`database-reference.md`](../10-reference/database-reference.md) for the full environment-variable reference covering log level, log format, and database options.
