...
- [Sections & Field Groups guide](./sections-groups.md) — the structure stateful strategies consume.
- [Prompt Creation guide](./prompt-creation.md) — the broader strategy picture (stateless / hybrid / stateful).
