...
<!-- illustration: summary-strategies#temporal -->
...
- [Proximity Sampling Guide](../proximity-sampling.md) — when you've found a gap, this is how to spot-sample records around its edges.
