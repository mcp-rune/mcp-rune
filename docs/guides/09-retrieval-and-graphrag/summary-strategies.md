...
For the broader analysis-tool family, see [Analysis Memories Guide](./analysis-memories.md). For how to register your strategy through an `ApiExtension`, see [API Extensions](../10-extensions/api-extensions.md).
...
Two LLM-facing surfaces let the model pick. For a worked Inspector recipe per built-in strategy against a 5,000-record dataset, see the [Analysis Quickstart](./analysis-quickstart.md).
...
- [Analysis Memories Guide](./analysis-memories.md) — the broader `analysis_*` tool family.
- [API Extensions](../10-extensions/api-extensions.md) — the `ApiExtensionContext` collectors, including `registerSummaryStrategy`.
- [Authoring Extensions Guide](../10-extensions/authoring-extensions.md) — step-by-step walkthrough for shipping an extension.
