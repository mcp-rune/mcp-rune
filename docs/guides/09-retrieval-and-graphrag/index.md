...
1. [Retrieval & GraphRAG overview](./retrieval-graphrag.md) — start here: how vectors, edges, and domain combine into GraphRAG, and which chapter owns each piece.
...
5. [Analysis quickstart](./analysis-quickstart.md) — bring up pgvector and walk all five summary strategies end to end against the `bookshelf-graph` fixtures.
