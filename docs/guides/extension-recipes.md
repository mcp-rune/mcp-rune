...
→ Full references: [Tool Creation](./tool-creation-guide.md) for the `BaseTool` contract, [API Extensions](./api-extensions.md) for the registration shape.
...
→ Full reference: [Extensions (HttpExtension)](./extensions.md). Worked example with capabilities: the built-in [CIMD extension](../../src/extensions/cimd.ts).
...
→ Full reference: [Tool Flow Extension Guide](./tool-flow-extension-guide.md). Worked example: [`src/extensions/center-of-control.ts`](../../src/extensions/center-of-control.ts).
...
→ Full reference: [Summary Strategies](./summary-strategies.md). The built-in strategies live under [`src/core/summary-strategies/`](../../src/core/summary-strategies/).
...
→ Full reference: [Custom API Convention](./api-convention-guide.md).
...
→ Full reference: [DataLayer Guide](./data-layer-guide.md), §"In-Memory Stub for Tests."
...
- [Extensibility Overview](./extensibility-overview.md) — the seam map and the five conventions every extension follows.
- [Authoring Extensions](./authoring-extensions-guide.md) — assembly contract shared by `HttpExtension` and `ApiExtension`.
- [Extensions (HttpExtension)](./extensions.md), [API Extensions](./api-extensions.md), [Tool Flow Extension Guide](./tool-flow-extension-guide.md) — the three typed extension surfaces.
