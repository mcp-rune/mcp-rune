...
For listing the actual records of a model, use find_model_app (visual table) or search_records / find_records (raw JSON).`
  }
      ...
      return {
        ...
        filterable_search: filters
          ? {
              ...
              hint: 'Call get_filters_guide for filter docs, then use search_records (raw JSON) or find_model_app (interactive)'
            }
          : undefined
      }
    })
